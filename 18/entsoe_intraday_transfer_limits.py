...
for eic1 in con2[1:]:
    for eic in con2[1:]:
        formed_url="https://transparency.entsoe.eu/api?securityToken=5cd9c738-3b32-4b95-86e9-f9c8b2cd3bb6&documentType=A93&in_Domain="+str(eic)+"&out_Domain="+str(eic1)+"&periodStart=201512312300&periodEnd=201612312300"
        print formed_url
        ping1=requests.get(formed_url,verify=False)
        print ping1.status_code
        ping_count+=1
        with open("eic_codes_intraday_transfer_limits.txt","ab") as f:
