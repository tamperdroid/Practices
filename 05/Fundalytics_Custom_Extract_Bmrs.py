                ...
                for files in fileList:
                    if str(scraper_parameters) in files:
                        ...
                        if '.csv' in files:
                            ...
                            print 'scraperParameterName==>',scraper_parameters
...
def main(control):
    try:
        ...
        for scraper_parameters in spName:
            ...
            print "=url after date_function=>",get_url_to_scrape
                ...
                if method[0] in ("GET", 'GET_BY'):
                    ...
                    try:
                        if str(ck)!='{}':
                            ...
                            print '==str(marketName)==>',str(marketName)
