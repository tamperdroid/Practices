...
Fundalytics_Utility = imp.load_source('Fundalytics_Utility', 'D:/01_2017/10/Fundalytics_Utility.py')
...
tempFilePath = "D:/01_2017/10/temp/"
...
def main(Config):
    ...
    if int(validationStatus) != 0:
        ...
        if int(process_error) == 0:
            ...
            print "Number of Records " + str(value_count)
